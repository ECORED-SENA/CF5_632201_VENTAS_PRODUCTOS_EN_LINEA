  ...
  .container.BGIMG03.px-4.px-md-5.pt-4    
    .row.justify-content-center
      ...
      .col-md-8.col-12.BG22(data-aos="fade-right")
        p <b>El diseño del buyer persona es una etapa fundamental para el marketing digital. El buyer persona es la figura no real que se edifica a partir de los datos reales y el análisis correcto de la información obtenida en los procesos o técnicas de segmentación objetiva, la cual brinda todas las herramientas para conocer y tomar decisiones que vayan en dirección a esa figura de una forma más individual y humanizada. Este ejercicio permite segmentar, determinar quién es ese consumidor, a qué se dedica y cuáles son sus intereses. </b>
        .row.mb-4.p-4.pb-5
          .col-1
            figure
    ...
    .row.justify-content-center
      .col-lg-10.col-12.mb-5
        .titulo-sexto.color-acento-botones(data-aos="fade-right")
          h5 Figura 1
          span Perfil de un buyer persona.
